resource "aws_subnet" "app-manraaj" {
  vpc_id     = "${var.vpc_id}"
...
resource "aws_route_table_association" "public-manraaj" {
    subnet_id = "${aws_subnet.app-manraaj.id}"
    route_table_id = "${var.route_table_id}"
}

resource "aws_security_group" "app-manraaj" {
  name        = "${var.name}"
...
resource "aws_security_group_rule" "rule" {
  ...
  security_group_id = "${aws_security_group.app-manraaj.id}"
}
